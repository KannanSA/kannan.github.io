      ...
      content: (
        <div>
          <div className="flex items-start gap-4 mb-4">
            <div className="w-12 h-12 bg-white border border-gray-200 rounded-lg flex items-center justify-center flex-shrink-0">
              <Image
                src="https://github.com/KannanSA/kannan.github.io/blob/main/old/images/UCL.png"
      ...
      content: (
        <div>
          <div className="flex items-start gap-4 mb-4">
            <div className="w-12 h-12 bg-white border border-gray-200 rounded-lg flex items-center justify-center flex-shrink-0">
              <Image
                src="https://github.com/KannanSA/kannan.github.io/blob/main/old/images/RGS.png"
